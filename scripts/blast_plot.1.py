...
blast_G_muris = pd.read_csv('/Users/melisanuralparslan/PycharmProjects/Miuul/output/blastn/G_intestinalis/G_muris.blastn', sep='\t', header=None)
blast_S_salmonicida = pd.read_csv('/Users/melisanuralparslan/PycharmProjects/Miuul/output/blastn/G_intestinalis/S_salmonicida.blastn', sep='\t', header=None)


blast_G_muris.columns = ['qseqid', 'sseqid', 'pident', 'length', 'mismatch', 'gapopen', 'qstart', 'gend', 'sstart', 'send', 'evalue', 'bitscore']
blast_S_salmonicida.columns = ['qseqid', 'sseqid', 'pident', 'length', 'mismatch', 'gapopen', 'qstart', 'gend', 'sstart', 'send', 'evalue', 'bitscore']
